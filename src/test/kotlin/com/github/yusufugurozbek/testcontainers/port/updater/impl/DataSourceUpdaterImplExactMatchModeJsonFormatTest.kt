...
internal class DataSourceUpdaterImplExactMatchModeJsonFormatTest : DataSourceUpdaterImplBaseTestCase() {

    override fun setUp() {
        super.setUp()
        project.service<TpuSettingsState>().matchMode = MatchMode.EXACT
